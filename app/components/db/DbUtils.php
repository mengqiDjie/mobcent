...
class DiscuzDbUtils {
    ...
    public function queryFirst($sql='',$params=array()) {
    ...
    public function insert($tableName, $data, $return_insert_id = false, $replace = false, $silent = false) {
        return DB::insert($tableName, $data, $return_insert_id, $replace, $silent);
    }
