...
class CacheUtils {
    ...
    public static function getShareActivityKey($params) {
        return self::_getCacheKey('share', $params);
    }

    public static function getUiDiyKey($params){
        return self::_getCacheKey('uidiy', $params);
    }

    public static function getUiDiyMd5Key($params){
        return self::_getCacheKey('uidiy_Md5', $params);
    }
