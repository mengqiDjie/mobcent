...
class ForumController extends MobcentController {
    ...
    public function actions() {
        return array(
            ...
            'topiclistex' => 'application.controllers.forum.TopicListExAction',
            ...
            'topicadminex' => 'application.controllers.forum.TopicAdminExAction',
            'checktopicadmin'=>'application.controllers.forum.CheckTopicAdminAction',
            'updateforum'=>'application.controllers.forum.UpdateForumAction',
        );
    }
